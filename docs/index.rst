...
To compile the code with GPU acceleration, an NVidia GPU must be available with all relevant software installed, and the configuration step of the compilation must have the `--enable-cuda` switch added.  See the :ref:`Installation` section for more details.
